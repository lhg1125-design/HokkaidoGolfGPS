#!/usr/bin/env bash
set -euo pipefail
APK="HokkaidoGolfGPS-v1.13.6-round-log-debug.apk"
PKG="com.hokkaidogolf.trip"
ACTIVITY="com.hokkaidogolf.trip/.FieldGpsV09Activity"
OUT="preview-v1136-round-log"
...
adb shell pm grant "$PKG" android.permission.ACCESS_FINE_LOCATION || true
adb shell pm grant "$PKG" android.permission.ACCESS_COARSE_LOCATION || true
shot 3 0 1 1 "00-naepo-h1-live-geo.png"
shot 3 0 4 1 "01-naepo-h4-live-geo.png"
shot 2 0 13 1 "02-sahoro-h13-live-geo.png"
shot 3 0 1 4 "03-round-summary-log-button.png"
adb shell wm size 720x1600; adb shell wm density 320; sleep .5
shot 3 0 2 1 "04-compact-naepo-h2.png"
adb shell wm size reset; adb shell wm density reset
if adb logcat -d | grep -E "FATAL EXCEPTION|Process: ${PKG}" | grep -q "${PKG}\|FATAL EXCEPTION"; then
  echo "App crash detected during V1.13.6 ROUND LOG preview run"; adb logcat -d | tail -500; exit 1
fi
printf 'V1.13.6 ROUND LOG screenshots:\n'; ls -lh "$OUT"/*.png

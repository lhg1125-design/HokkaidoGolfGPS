...
public class BetaSimActivity extends Activity {
    ...
    private View buildUi(){
        ...
        TextView note=label("※ SIM은 기능 검증용입니다. REGULAR/WHITE 거리값은 실제 데이터 그대로 유지하며, 좌표가 없는 해저드 형상은 GUIDE로 표시됩니다.",13,Color.DKGRAY,false);
        ...
        TextView tip=label("추천 리허설: MASTERS H13 → H15 → PALMER H15 → KING H17 → 스코어 입력/카드",13,Color.rgb(90,100,90),false);

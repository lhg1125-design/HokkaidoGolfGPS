...
replacement = '''        private void drawCourse(Canvas c,RectF r,int par,int officialM,GeoRef green,Distances ds,float pulse){
            ...
            // V1.13.6 LITE PREMIUM YARDAGE: verified Hokkaido hole image, FIT-CENTER only (no crop).
            ...
            // Preserve the existing field target interaction without cropping the master image.
            if(hasTarget){
...
p.write_text(s2)
print('V1.13.6 Lite premium yardage renderer patched')
